...
class DenseNet(nn.Module):
    def __init__(self, init_channels=192, growth_rate=32, blocks=[6, 12, 12, 12], num_classes=10):
        ...
        self.layer4 = nn.Conv2d(in_channels=num_features, out_channels=64, kernel_size=1, stride=1, padding=0, bias=False)
